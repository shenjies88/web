// JavaScript Document
	...
	function change(){
		...
		switch(indext[3]){
			case 1:document.getElementById("neirong").innerHTML="魔鬼城";
			 break;
			 			case 2:document.getElementById("neirong").innerHTML="长城第一墩";
			 break;
			 			case 3:document.getElementById("neirong").innerHTML="河西走廊";
			 break;
			 			case 4:document.getElementById("neirong").innerHTML="天下第一嘉峪关";
			 break;
			 			case 5:document.getElementById("neirong").innerHTML="美丽的月牙潭";
			 break;
		}
